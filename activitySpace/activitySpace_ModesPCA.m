...
if contains(k.unit_quality, 'ok or good')
    ...
    rel_Selectivity =((EXP.Session * EXP.SessionID * ANL.Selectivity * EPHYS.Unit * EPHYS.UnitPosition *   EPHYS.UnitCellType * EXP.SessionTraining    *  ANL.IncludeSession ) ) & k & 'unit_quality!="multi"' ;
else
    rel_Selectivity =((EXP.Session * EXP.SessionID * ANL.Selectivity * EPHYS.Unit * EPHYS.UnitPosition *   EPHYS.UnitCellType * EXP.SessionTraining    *  ANL.IncludeSession ) ) & k ;
end
...
% for i = 1:1:numel(max_selectivity)
%     max(unit_selectivity(i,:))
% 
% unit_selectivity(i,:)=unit_selectivity(i,:)./max(unit_selectivity(i,:));
% end
