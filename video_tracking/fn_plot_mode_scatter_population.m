function fn_plot_mode_scatter_population(rel, key, tuning_param_label, rel_P,mode_time1_st,mode_time1_end)
...
time_idx_2plot = (time >=mode_time1_st & time<mode_time1_end + 0.5);
