function fn_plot_regression_2DGo(rel_P,  key, tuning_param_name_2D, tuning_param_label_2D, graphic_param)
...
rel_behav= EXP.TrialID & ((EXP.BehaviorTrial * EXP.SessionID * EXP.SessionTraining *ANL.SessionPosition * EXP.TrialName  * ANL.TrialTypeGraphic * ANL.Video1stLickTrialNormalized) & key & ANL.VideoTongueValidRTTrial & 'early_lick="no early"'  & ANL.IncludeSession-ANL.ExcludeSession);
...
idx_v1=~isoutlier(table2array(TONGUE(:,tuning_param_name_2D.x)));
idx_v2=~isoutlier(table2array(TONGUE(:,tuning_param_name_2D.y)));
