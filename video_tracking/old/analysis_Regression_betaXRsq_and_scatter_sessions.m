function analysis_Regression_betaXRsq_and_scatter_sessions()
close all;
...
dir_save_figure = [dir_root 'Results\video_tracking\analysis\regression_sessions_all_betaXrsq3\' 't' num2str(key.regression_time_start) '\'];
...
tuning_param_name_1D{1}='lick_rt_video_onset';
