function analysis_RegressionModesPopulationW4()
close all;
...
dir_save_figure = [dir_root 'Results\video_tracking\analysis\RegressionModes_population2_w4\' 't' num2str(key.regression_time_start) '\'];
...
rel=ANL.RegressionDecoding2Weigts4*ANL.SessionPosition*EXP.SessionTraining;
rel_P=ANL.RegressionProjTrial2Weights4*ANL.SessionPosition*EXP.SessionTraining;
