function analysis_RegressionModesPopulation()
close all;
...
dir_save_figure = [dir_root 'Results\video_tracking\analysis\RegressionModes_population2\' 't' num2str(key.regression_time_start) '\'];
...
rel=ANL.RegressionDecodingbetaXR2Time*ANL.SessionPosition*EXP.SessionTraining;
