...
dir_save_figure = [dir_root 'Results\video_tracking\analysis\regression\' key.lick_direction '\'];
...
session_uid=unique(fetchn( ((EXP.SessionID*EXP.SessionTraining*ANL.SessionPosition) & ANL.Video1stLickTrialNormalized  & k & ANL.IncludeSession)-ANL.ExcludeSession,'session_uid'));
