function analysis_RegressionModesScatterSessionsW4()
close all;
...
dir_save_figure = [dir_root 'Results\video_tracking\analysis\RegressionModes_scatter_sessions2_w4\' 't' num2str(key.regression_time_start) '\'];
