function analysis_Regression_decodingTime2_population_rsq()
close all;
...
dir_save_figure = [dir_root 'Results\video_tracking\analysis\regression_decoding_rsq3\' 't' num2str(key.regression_time_start) '\'];
...
for i_p=1:1:numel(tuning_param_name_1D)
    for  i_d=1:1:numel(lick_direction_name)
        ...
        fn_plot_regression_decoding_time_rsq (rel,  key, tuning_param_label{i_p}, rel_significant_cells);
