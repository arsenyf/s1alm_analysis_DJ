function analysis_RegressionModesPopulationW3()
close all;
...
dir_save_figure = [dir_root 'Results\video_tracking\analysis\RegressionModes_population2_w3\' 't' num2str(key.regression_time_start) '\'];
...
rel=ANL.RegressionDecoding2Weigts3*ANL.SessionPosition*EXP.SessionTraining;
rel_P=ANL.RegressionProjTrial2Weights3*ANL.SessionPosition*EXP.SessionTraining;
