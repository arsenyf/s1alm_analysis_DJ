function [RMSE_left,RMSE_right] = fn_ml_decoder_single_cell (analyzed_trials, PV_at_t, x_est_range_trials, tol,Y, left_trials, right_trials, tuning_curves, hist_bins_centers)
