function [R2_LinearRegression,R2_LogisticRegression]=fn_plot_regression_scatter_sessionGo(rel_P,  key, tuning_param_label)
...
TONGUE = struct2table(fetch((ANL.Video1stLickTrial & rel_behav & key)*EXP.TrialID,'*' , 'ORDER BY trial_uid'));
